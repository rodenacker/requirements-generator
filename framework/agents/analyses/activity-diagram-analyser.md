...
Section order lives in `framework/assets/analyses/template-activity-diagram.html`, not in this analyser. The analyser emits the same placeholder blocks regardless; the template decides where they land.
