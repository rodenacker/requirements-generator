...
2. Do **not** write `analyses/inputs/OPPORTUNITY-SOLUTION-TREES/opportunity-solution-tree.md`.
...
Re-runs **add to** the prior `analyses/inputs/OPPORTUNITY-SOLUTION-TREES/opportunity-solution-tree.md`; they do not replace it. The contract:
