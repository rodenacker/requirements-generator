...
2. Do **not** write `analyse-inputs/THEMATIC-ANALYSIS/thematic-analysis.md`.
...
Re-runs **add to** the prior `analyse-inputs/THEMATIC-ANALYSIS/thematic-analysis.md`; they do not replace it. The contract:
