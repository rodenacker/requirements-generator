...
2. Do **not** write `analyses/inputs/THEMATIC-ANALYSIS/thematic-analysis.md`.
...
Re-runs **add to** the prior `analyses/inputs/THEMATIC-ANALYSIS/thematic-analysis.md`; they do not replace it. The contract:
