...
| GR-23 | §6.1 / §6.2 `Acceptance criteria` cells | Phrase in EARS (`When/While/Where … the system shall …`; `If <unwanted>, then …`; ≤3 preconditions). §4.2 / §5 / §6.4 keep observable-signal / Given-When-Then; §6.3 already EARS event-driven by construction. |
| GR-24 | `Priority` field on §4.2 stories, §6.1 F-NN, §6.4 UI-NN when input is silent | MoSCoW default — Must (In + top-level goal), Should (In + sub/interaction goal), Could (Deferred / unlinked), Won't (Out). Carries `[STANDARD-RULE: GR-24]`; consultant-overridable in the merge. |
