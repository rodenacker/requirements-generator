...
**Used how:** Called when the user-stories analysis is present. Stories grouped by target-user persona drive role-gated UI; MoSCoW priority informs screen prioritisation.
